...
/**
 * This class possesses two fields \texttt{y} de type \texttt{double}
 * representing the coordinate of the Point and a String label.
 * It has 3 constructors; interestingly and to re-use code and avoid code
 * duplication, constructors invok each other.
 * 
 * @author ceichler
 *
 */
...
public class Point {
	...
	/**
	 * Default point constructor (gives origin). Relies on the constructor with 3
	 * arguments
	 */
	public Point() {
		this(0.0, 0.0, "O");
